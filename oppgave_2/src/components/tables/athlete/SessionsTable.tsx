...
const SessionsTable: React.FC = () => {
  ...
  const [sortByDate, setSortByDate] = useState<"asc" | "desc">("desc"); // Change the type to a string
  ...
  return (
    <>
      <h1 className="text-3xl px-6 pt-6 font-bold">Se øktene til {athleteId}</h1>
    <section className="px-6">
      <div className="mb-4">
        {/* Legg til filter for type aktivitet */}
        <select
          id="typeFilter"
        ...
        >
          ...
          {/* Legg til flere tags etter behov */}
        </select>

        {/* Legg til filter for status */}
        <select
          id="statusFilter"
